...
<head>
    ...
    <link rel="shortcut icon" href="Assets/Images/hero banner.jpg" type="image/x-icon">
</head>
<body>
    <header>
      <div>
      ...
      <input type="checkbox" hidden name="user-menu" id="user-menu">
        <div class="menu">
            <div id="sign-in">
                <?php
                if($status==false){
                echo '<p id="p4"><a id="p3" href="pages/login.html">Sign in</a> To Contine</p>';
                }
                else{
